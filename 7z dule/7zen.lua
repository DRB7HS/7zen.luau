-- Global variables / Services Initialization
...
local function revertAtardecer()
	...
	local rainSound = workspace:FindFirstChild("RainSound")
	if savedRainSound and savedRainSound.exists and rainSound and rainSound:IsA("Sound") then
...
local S = {
	...
	medusaDebounce = false, medusaLastUsed = 0, medusaConns = {},
	MEDUSA_COOLDOWN = 25,
	unwalkEnabled = false,
	autoLeftEnabled = false, autoRightEnabled = false,
	autoLeftSetVisual = nil, autoRightSetVisual = nil,
	btnAAL = nil, _bsAAL = nil, _l1AAL = nil, _l2AAL = nil,
	btnAAR = nil, _bsAAR = nil, _l1AAR = nil, _l2AAR = nil,
	btnBAT = nil, _bsBAT = nil, _l1BAT = nil, _l2BAT = nil,
	btnBAT2 = nil, _bsBAT2 = nil, _l1BAT2 = nil, _l2BAT2 = nil,
	setPButtonActive = nil, speedCounterLabel = nil,
	...
	noclipTimer = 0, _fpsCount = 0, _lastFpsTime = tick(), currentFPS = 0,
...
S.setupSpeedBillboard = function(char)
	...
	local oldBB = head:FindFirstChild("STARHUBSpeedBB")
	if oldBB then oldBB:Destroy() end

	local bb = Instance.new("BillboardGui", head)
	bb.Name = "STARHUBSpeedBB"
	...
	S.bat2Conn = RunService.RenderStepped:Connect(function()
		...
		if target then
			...
			if toPredict.Magnitude > 0.1 then
				...
				root.AssemblyAngularVelocity = root.CFrame:VectorToWorldSpace(Vector3.new(rx * BAT2_TILT_SPEED, ry * BAT2_TILT_SPEED, rz * BAT2_TILT_SPEED))
			end
...
local function swingBatForCounter(bat, char)
	...
	if remote and remote:IsA("RemoteEvent") then
		...
		pcall(function() bat:Activate() end); task.wait(0.05); pcall(function() bat:Activate() end)
	end
end
...
-- CONSTRUCCIÓN DE LA INTERFAZ CON COLOR AZUL MARINO
local function buildGui()
	...
	local C_ACCENT = Color3.fromRGB(0, 0, 128) -- AZUL MARINO
	...
	local old = game:GetService("CoreGui"):FindFirstChild("STARHUB")
	...
	topBarDiv.Position = UDim2.new(0,10,0,44)
	...
	local function mkToggle(pg, pages, label, defKey, defOn, onToggle, onKeyChanged)
		local C_ON = C_ACCENT -- azul marino
	...
	S.miniToggleButton = buildGui_createMiniToggle(gui, function()
		main.Visible = true
